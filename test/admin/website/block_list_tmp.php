...
function del() {
    ...
    {
        $.ajax({
            url:"<?=$this->SYSTEM_path("admin/website/block_clear")?>",
                dataType:"html",
                data:"",
                type:"post",
...
<form name="form2" id="form2" method="post" action="" onSubmit="return check()">
  <table cellspacing="1" cellpadding="5" width="100%" style="margin:6px 0 0 0;">
   <tr>
  <td colspan="13" style="color:#FF0000;font-weight:bold;">当前：block监控记录&nbsp;<input type="button" value="删除2天前记录" onclick="del()"></td>
  </tr>
  <tr class="head">
