...
$.extend(Dialog,{
	...
	popTip:function(title,message,delay,options){
		var settings=$.extend({modal: false, closeable:false,closeDelay: delay}, options || {});
		var html = $("<div class='okbox'></div>").append(message);
        new Dialog(html, settings);
	},
    //询问框
	ask:function(question, answers, callback, options){
		options = $.extend({modal: true, closeable: false},options || {});
        var body =$("<div class='askbox'></div>").append($('<div class="question"></div>')).html(question);
        ...
        var buttons = $('<form class="answers"><div class="answers-inner"></div></form>');
